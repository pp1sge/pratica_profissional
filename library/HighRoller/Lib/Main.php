...
class HighRoller_Lib_Main
{
    ...
    function __construct()
    {
        ...
        $this->chart = new HighRoller_Lib_Chart();
        $this->title = new HighRoller_Lib_Title();
        $this->subtitle = new HighRoller_Lib_Title();
        $this->legend = new HighRoller_Lib_Legend();
        $this->tooltip = new HighRoller_Lib_ToolTip();
        $this->plotOptions = new HighRoller_Lib_PlotOptions($this->chart->type);
        $this->series = new HighRoller_Lib_Series();
    }
  ...
  <script type='text/javascript' src='" . $location . "'></script>";
    ...
    {
        Zend_Loader::loadClass('HighRoller_Lib_Options');
        $options = new HighRoller_Lib_Options(); // change file/class name to new HighRollerGlobalOptions()
